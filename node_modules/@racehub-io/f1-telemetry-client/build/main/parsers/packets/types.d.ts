...
export interface GenericEvent extends PacketBase {
    m_eventStringCode: 'SSTA' | 'LGOT' | 'RDFL' | 'SEND' | 'DRSE' | 'DRSD' | 'CHQF';
}
...
export declare type PacketEvent = GenericEvent | LightEvent | ButtonEvent | VehicleEvent | OvertakeEvent | PenaltyEvent | FlashbackEvent | FastestLapEvent | SpeedTrapEvent;
export declare type Packet = PacketSessionHistoryData | PacketSessionData | PacketMotionData | PacketLapData | PacketEvent | PacketParticipantsData | PacketCarSetupData | PacketCarTelemetryData | PacketCarStatusData | PacketCarDamageData | PacketFinalClassificationData | PacketLobbyInfoData | PacketTyreSetsData | PacketMotionExData;
